...
public class Building implements IBuilding {
    ...
    @Override
    public Owner[] getOwners(String door, int floor) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getAddress(), building.getAddress()) && Objects.equals(getCity(), building.getCity()) && Arrays.equals(getApartments(), building.getApartments());
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(getAddress(), getCity());
        result = 31 * result + Arrays.hashCode(getApartments());
        return result;
    }
}
